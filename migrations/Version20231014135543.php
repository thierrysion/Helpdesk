 ...
 */
final class Version20231014135543 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recaptcha (id INT AUTO_INCREMENT NOT NULL, site_key VARCHAR(255) DEFAULT NULL, secret_key VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_article_category (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, category_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_article_history (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, user_id INT NOT NULL, content LONGTEXT NOT NULL, date_added DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE uv_article_tags (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, tag_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_prepared_response_support_groups (group_id INT NOT NULL, savedReply_id INT NOT NULL, INDEX IDX_A22590198D3102C3 (savedReply_id), INDEX IDX_A2259019FE54D947 (group_id), PRIMARY KEY(savedReply_id, group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE uv_prepared_response_support_teams (subgroup_id INT NOT NULL, savedReply_id INT NOT NULL, INDEX IDX_B6897DEB8D3102C3 (savedReply_id), INDEX IDX_B6897DEBF5C464CE (subgroup_id), PRIMARY KEY(savedReply_id, subgroup_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE uv_related_articles (id INT AUTO_INCREMENT NOT NULL, article_id INT NOT NULL, related_article_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_saved_replies_groups (group_id INT NOT NULL, savedReply_id INT NOT NULL, INDEX IDX_C59C13668D3102C3 (savedReply_id), INDEX IDX_C59C1366FE54D947 (group_id), PRIMARY KEY(savedReply_id, group_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE uv_saved_replies_teams (subgroup_id INT NOT NULL, savedReply_id INT NOT NULL, INDEX IDX_D240CE708D3102C3 (savedReply_id), INDEX IDX_D240CE70F5C464CE (subgroup_id), PRIMARY KEY(savedReply_id, subgroup_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_solution_category_mapping (id INT AUTO_INCREMENT NOT NULL, solution_id INT NOT NULL, category_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_support_label (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(191) NOT NULL, color_code VARCHAR(191) DEFAULT NULL, INDEX IDX_EFD454DDA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_support_role (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(191) NOT NULL, description VARCHAR(191) DEFAULT NULL, UNIQUE INDEX UNIQ_2AF5A72177153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE uv_support_team (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(191) NOT NULL, description LONGTEXT NOT NULL, created_at DATETIME NOT NULL, is_active TINYINT(1) DEFAULT \'0\' NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE uv_tag (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_tickets_collaborators (ticket_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_20764CBA700047D2 (ticket_id), INDEX IDX_20764CBAA76ED395 (user_id), PRIMARY KEY(ticket_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE uv_tickets_tags (ticket_id INT NOT NULL, tag_id INT NOT NULL, INDEX IDX_CF4DF9E3700047D2 (ticket_id), INDEX IDX_CF4DF9E3BAD26311 (tag_id), PRIMARY KEY(ticket_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE uv_tickets_labels (ticket_id INT NOT NULL, label_id INT NOT NULL, INDEX IDX_305F9C0E700047D2 (ticket_id), INDEX IDX_305F9C0E33B92F39 (label_id), PRIMARY KEY(ticket_id, label_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_ticket_priority (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(191) NOT NULL, description LONGTEXT DEFAULT NULL, color_code VARCHAR(191) DEFAULT NULL, UNIQUE INDEX UNIQ_FFA6CF8677153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_ticket_type (id INT AUTO_INCREMENT NOT NULL, code VARCHAR(191) NOT NULL, description LONGTEXT DEFAULT NULL, is_active TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_3E0B313677153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_user_support_teams (userInstanceId INT NOT NULL, supportTeamId INT NOT NULL, INDEX IDX_5F33E9F78B414560 (userInstanceId), INDEX IDX_5F33E9F7A77C7023 (supportTeamId), PRIMARY KEY(userInstanceId, supportTeamId)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        $this->addSql('CREATE TABLE uv_user_support_groups (userInstanceId INT NOT NULL, supportGroupId INT NOT NULL, INDEX IDX_B6CD76C28B414560 (userInstanceId), INDEX IDX_B6CD76C253F5B65F (supportGroupId), PRIMARY KEY(userInstanceId, supportGroupId)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
        ...
        $this->addSql('CREATE TABLE uv_workflow_events (id INT AUTO_INCREMENT NOT NULL, workflow_id INT DEFAULT NULL, event_id INT NOT NULL, event VARCHAR(191) NOT NULL, INDEX IDX_6AEB02A92C7C2CBA (workflow_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB ROW_FORMAT = DYNAMIC');
