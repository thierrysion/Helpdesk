 ...
 */
final class Version20231023202319 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE country CHANGE code code VARCHAR(50) NOT NULL');
        $this->addSql('ALTER TABLE handicap CHANGE libelle libelle VARCHAR(64) NOT NULL');
        $this->addSql('ALTER TABLE location CHANGE parent_id parent_id INT DEFAULT NULL, CHANGE code code VARCHAR(50) NOT NULL');
        ...
        $this->addSql('ALTER TABLE ticket_location CHANGE nationalite_id nationalite_id INT DEFAULT NULL, CHANGE status_id status_id INT DEFAULT NULL, CHANGE handicap_id handicap_id INT DEFAULT NULL, CHANGE telephone telephone VARCHAR(50) DEFAULT NULL, CHANGE village village VARCHAR(100) DEFAULT NULL, CHANGE quartier quartier VARCHAR(100) DEFAULT NULL');
        $this->addSql('ALTER TABLE user_infos CHANGE status_id status_id INT DEFAULT NULL, CHANGE nationalite_id nationalite_id INT DEFAULT NULL, CHANGE handicap_id handicap_id INT DEFAULT NULL, CHANGE telephone telephone VARCHAR(50) DEFAULT NULL, CHANGE village village VARCHAR(100) DEFAULT NULL, CHANGE quartier quartier VARCHAR(100) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE handicap CHANGE libelle libelle VARCHAR(30) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE location CHANGE parent_id parent_id INT DEFAULT NULL, CHANGE code code VARCHAR(10) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE ticket_location CHANGE nationalite_id nationalite_id INT DEFAULT NULL, CHANGE status_id status_id INT DEFAULT NULL, CHANGE handicap_id handicap_id INT DEFAULT NULL, CHANGE telephone telephone VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE village village VARCHAR(100) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE quartier quartier VARCHAR(100) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE user_infos CHANGE nationalite_id nationalite_id INT DEFAULT NULL, CHANGE status_id status_id INT DEFAULT NULL, CHANGE handicap_id handicap_id INT DEFAULT NULL, CHANGE telephone telephone VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE village village VARCHAR(100) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE quartier quartier VARCHAR(100) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
